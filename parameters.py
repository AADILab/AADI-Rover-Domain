...
parameters["algorithm"] = "DPP"  # Global, Difference, DPP (D++), or Test
parameters["sample_rate"] = 20  # Spacing for collecting performance data during training (every X generations)
parameters["run_visualizer"] = False  # Boolean for deciding whether or not to run the visualizer

# Domain parameters
parameters["x_dim"] = 30.0  # X-Dimension of the rover map
parameters["y_dim"] = 30.0  # Y-Dimension of the rover map
